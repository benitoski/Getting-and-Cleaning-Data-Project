...
## setwd("C:/Users/OBENITEZ/Google Drive/E-learning/DataScienceSpecialization/03_Getting&CleaningData/data")
...
dim(joinData) 
## 10299*66
##some cleaning on column names, remove "()", capitalize M and S and change "-" by "_"
...
names(joinData) <- gsub("-", "_", names(joinData))
...
write.table(cleanedData, "./UCIHAR_Dataset/merged_data.txt") 
...
write.table(result, "./UCIHAR_Dataset/data_with_means.txt") 

# data <- read.table("./UCIHAR_Dataset/data_with_means.txt")
# head(data)